      ...
      <div className="space-y-6">
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <button 
              className={`p-4 rounded-lg border ${predictionType === 'availability' ? 'bg-primary text-white' : 'bg-white'}`}
              onClick={() => setPredictionType('availability')}
            >
              Parking Availability
            </button>
            <button 
              className={`p-4 rounded-lg border ${predictionType === 'rushHour' ? 'bg-primary text-white' : 'bg-white'}`}
              onClick={() => setPredictionType('rushHour')}
            >
              Rush Hour Prediction
            </button>
            <button 
              className={`p-4 rounded-lg border ${predictionType === 'demand' ? 'bg-primary text-white' : 'bg-white'}`}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {predictionType === 'availability' && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="parking_lot_id">Parking Lot ID</Label>
                    <input
                      type="number"
                      id="parking_lot_id"
                      name="parking_lot_id"
            ...
            {predictionType === 'rushHour' && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <Label htmlFor="avg_entry_15min">Avg. Entry (15min)</Label>
                    <input
                      type="number"
                      id="avg_entry_15min"
                  ...
                  <div>
                    <Label htmlFor="avg_exit_15min">Avg. Exit (15min)</Label>
                    <input
                      type="number"
                      id="avg_exit_15min"
                      name="avg_exit_15min"
                  ...
                  <div>
                    <Label htmlFor="avg_waiting_time">Avg. Waiting Time</Label>
                    <input
                      type="number"
                      id="avg_waiting_time"
                      name="avg_waiting_time"
            ...
            {predictionType === 'demand' && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <Label htmlFor="total_used_slots">Total Used Slots</Label>
                    <input
                      type="number"
                      id="total_used_slots"
                  ...
                  <div>
                    <Label htmlFor="total_booking_count">Total Booking Count</Label>
                    <input
                      type="number"
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full rounded-md bg-primary py-2 px-4 text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                disabled={isLoading}
              >
          ...
          <Card className="p-6">
            ...
            {parkingAvailabilityResult && predictionType === 'availability' && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white p-4 rounded-lg shadow border">
                  <h3 className="text-sm font-medium text-gray-500">Available Car Spots</h3>
                  <p className="text-2xl font-semibold mt-1">{parkingAvailabilityResult.available_car_spots}</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow border">
                  <h3 className="text-sm font-medium text-gray-500">Available Van Spots</h3>
                  <p className="text-2xl font-semibold mt-1">{parkingAvailabilityResult.available_van_spots}</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow border">
                  <h3 className="text-sm font-medium text-gray-500">Available Truck Spots</h3>
                  <p className="text-2xl font-semibold mt-1">{parkingAvailabilityResult.available_truck_spots}</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow border">
                  <h3 className="text-sm font-medium text-gray-500">Available Motorcycle Spots</h3>
            ...
            {demandResult && predictionType === 'demand' && (
              <div className="bg-white p-6 rounded-lg shadow border">
                ...
                <div className="flex items-center justify-center p-4">
                  <div className="text-3xl font-bold bg-blue-100 text-blue-600 p-6 rounded-full">
