      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        >
          ...
          {!loading && user && user.role && (
            <span className="ml-4 px-3 py-1 rounded bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 text-xs font-semibold">
              Role: {user.role}
            </span>
          )}
        </div>
