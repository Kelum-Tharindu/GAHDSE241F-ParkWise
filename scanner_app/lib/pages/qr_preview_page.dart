...
class QRPreviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String responseCode = qrData['response_Code'] ?? '';
  ...
  Widget _buildBillingReceipt(BuildContext context) {
    ...
    final billingData = qrData['data']?['billing'] ?? {};
    final double calculatedFee =
        (qrData['data']?['calculatedFee'] ?? 0).toDouble();
    final int duration = qrData['data']?['duration'] ?? 0;
    ...
    final entryTime =
        billingData['entryTime'] != null
            ...
            : DateTime.now();
    final exitTime =
        qrData['data']?['exitTime'] != null
            ? DateTime.parse(qrData['data']?['exitTime'])
            : DateTime.now();
  ...
  Widget _buildAlreadyPaidView(BuildContext context) {
    ...
    final String message =
        qrData['message'] ?? 'This QR code has already been used for payment';
